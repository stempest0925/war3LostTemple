...
function config takes nothing returns nothing
    call SetMapName("Lost Temple")
    call SetMapDescription("被众多金矿环绕着，生命之泉在向你招手。快速发展，否则会有被对手冲跨的危险。")
    call SetPlayers(6)
    call SetTeams(6)
    ...
    call DefineStartLocation(4, - 7171.2, 6553.6)
    call DefineStartLocation(5, 7016.0, 6417.2)
    // Player setup
